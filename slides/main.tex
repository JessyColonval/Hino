...
\begin{frame}{Real datasets}
    ...
    \begin{minipage}[c]{0.53\linewidth}
        \begin{tikzpicture}[scale=0.9]
            ...
            %\draw[->, bend left=-60, thick] (E.east) to (A.east);
        \end{tikzpicture}
        %\begin{itemize}
            %\item Cross-validation
            %\begin{itemize}
            %    \item Detected outliers removed.
            %    \item 70\% train + 30\% test
            %    \item \tikzarrow{0.75cm}{0.15cm}{0.1cm}\% of good prediction.
            %\end{itemize}
            %\item False positivity
            %\begin{itemize}
            %    \item Healthy as train + Outliers as test.
            %    \item \tikzarrow{0.75cm}{0.15cm}{0.1cm}\% of good prediction of test.
            %\end{itemize}
        %\end{itemize}
    \end{minipage}
    \vspace{0.25cm}
